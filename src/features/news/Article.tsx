					...
					<div className="overflow-hidden">
						<div className="relative max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 lg:py-12">
							...
							<div className="flex flex-col-reverse xl:grid xl:grid-cols-2">
									...
									<div className="relative mx-auto max-w-prose lg:max-w-md">
										<div className="bg-secondary border border-divider shadow overflow-hidden sm:rounded-lg mt-6">
											<div className="px-4 py-5 sm:px-6">
												<h3 className="text-lg leading-6 font-medium text-secondary">Article Information</h3>
											</div>
								...
								<div className="mt-8 lg:mt-0">{article.renderedContent && <div dangerouslySetInnerHTML={{ __html: article.renderedContent }}></div>}</div>
							</div>
						</div>
					</div>
				</>
