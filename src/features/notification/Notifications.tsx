										...
										<div className="flex justify-between space-x-3">
											<div className="min-w-0 flex-1">
												<div className="block focus:outline-none">
													...
													<p className={`text-sm font-medium ${archivedNotifications.includes(notification.id) ? "text-red-500" : "text-header"} truncate ${readNotifications.includes(notification.id) || archivedNotifications.includes(notification.id) ? "text-opacity-30" : "text-opacity-1"}`}>
