...
const Privacy = () => {
    ...
    const content = <div className="text-sm text-gray-700 px-6 py-4 space-y-3">
        <p>Our Privacy Policy was posted on 13 September 2012 and last updated on 22 Mar 2020. It governs the privacy
            terms of our website, located at TermsFeed.com, and the tools we provide you (the "Website" or the
            "Service"). Any capitalized terms not defined in our Privacy Policy, have the meaning as specified in our
            Terms of Use accessible at <a
                href="https://termsfeed.com/legal/terms-of-use">https://termsfeed.com/legal/terms-of-use</a></p>
        <h2 className="pt-3 pb-3">Your Privacy</h2>
        <p>Our Website follows all legal requirements to protect your privacy. Our Privacy Policy is a legal statement
            that explains how we may collect information from you, how we may share your information, and how you can
            limit our sharing of your information. You will see terms in our Privacy Policy that are capitalized. These
            terms have meanings as described in the Definitions section below.</p>
        <h2 className="pt-3 pb-3">Definitions</h2>
        <ul>
            <li>
                <strong>Personal Data:</strong> Personal Data means data about a living individual who can be identified
                from those data (or from those and other information either in our possession or likely to come into our
                possession).
            </li>
            <li>
                <strong>Usage Data:</strong> Usage Data is data collected automatically either generated by the use of
            ...
            <li>
                <strong>Data Controller:</strong> Data Controller means a natural or legal person who (either alone or
            ...
            <li>
                <strong>Data Processors (or Service Providers):</strong> Data Processor (or Service Provider) means any
                natural or legal person who processes the data on behalf of the Data Controller. We may use the services
                of various Service Providers in order to process your data more effectively.
            </li>
            <li>
                <strong>Data Subject:</strong> Data Subject is any living individual who is the subject of Personal
                Data.
            </li>
            <li>
                <strong>User:</strong> The User is the individual using our Service. The User corresponds to the Data
                Subject, who is the subject of Personal Data.
            </li>
        </ul>
        <h2 className="pt-3 pb-3">Information Collection And Use</h2>
        <p>We collect several different types of information for various purposes to provide and improve our Service to
            you.</p>
        <h3 className="text-muted pt-2 pb-3">Types of Data Collected</h3>
        <ul>
            <li>
                ...
                <p>While using our Service, we may ask you to provide us with certain personally identifiable
                    ...
                    information may include, but is not limited to: Email address, Name, Address, State, Province,
                    ZIP/Postal code, City, Cookies and Usage Data.</p>
            ...
            <li>
                ...
                </p><p>We may also collect information how the Service is accessed and used ("Usage Data"). This Usage
            ...
            <li>
                ...
                <p>Examples of Cookies we use: <strong>session cookies</strong> (we use these cookies to operate our
                    Service) and <strong>preference cookies</strong> (we use these cookies to remember your preferences
                    and various settings).</p>
            </li>
        </ul>
        <h2 className="pt-3 pb-3">Use of Data</h2>
        ...
        <h2 className="pt-3 pb-3">Retention of Data</h2>
        ...
        <h2 className="pt-3 pb-3">Transfer Of Data</h2>
        ...
        <p>We will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
        ...
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement
            to that transfer.</p>
        <h2 className="pt-3 pb-3">Disclosure Of Data</h2>
        <ul>
            <li><strong>Business Transaction.</strong> If we are involved in a merger, acquisition or asset sale, your
        ...
        <h2 className="pt-3 pb-3">Security Of Data</h2>
        ...
        <h2 className="pt-3 pb-3">Legal Basis for Processing Personal Data Under General Data Protection Regulation
            (GDPR)</h2>
        <p>If you are from the European Economic Area (EEA), TermsFeed legal basis for collecting and using the personal
        ...
        <h2 className="pt-3 pb-3">Your Data Protection Rights Under General Data Protection Regulation (GDPR)</h2>
        <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. TermsFeed
        ...
        <ul>
            ...
            <li>
                <p><strong>The right to data portability.</strong> You have the right to be provided with a copy of your
            ...
            <li>
                <p><strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at
                    any time where TermsFeed relied on your consent to process your personal information.</p>
            </li>
        </ul>
        ...
        <p>You have the right to complain to a Data Protection Authority about our collection and use of your Personal
            ...
            Area (EEA).</p>
        <h2 className="pt-3 pb-3">"Do Not Sell My Personal Information" Notice for California consumers under California
        ...
        <p>If you make a request, we have 30 days to respond to you. If you would like to exercise any of these rights,
            please contact us.</p>
        <h2 className="pt-3 pb-3">Service Providers</h2>
        ...
        <h3 className="text-muted pt-2 pb-3">Analytics</h3>
        ...
        <h3 className="text-muted pt-2 pb-3">Payments</h3>
        ...
        <h2 className="pt-3 pb-3">Links To Other Sites</h2>
        ...
        <h2 className="pt-3 pb-3">Children's Privacy</h2>
        ...
        <h2 className="pt-3 pb-3">Changes To This Privacy Policy</h2>
