...
import {
    setFiltersVisible,
} from "../SelectableGridSlice"

function SelectableGridToggleFilter({ name, className = '', resetQueryFilters }: { name: string, className?: string, resetQueryFilters: () => void }) {
    const dispatch = useDispatch()
    const areFiltersVisible = useSelector((state: any) => Boolean(state?.selectableGrid[name]?.areFiltersVisible))
...
export { SelectableGridToggleFilter }